...
def train_sft_model(model_name="unsloth/gemma-3-1b-it", max_steps=100, save_path="gemma-3-1b-haiku"):
    """
    ...
    print("Loading dataset from: train_dataset/sft_data.json")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save_path", type=str, default="gemma-3-1b-haiku", help="Path to save the fine-tuned model")
